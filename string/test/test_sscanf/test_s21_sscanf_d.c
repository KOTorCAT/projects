...
START_TEST(test_13) {
  char format[100] = "%*d%*d%10d%2d%21d%111d";
  char str[100] = "+21 -1 0 +0 -0  -21";
...
START_TEST(test_14) {
  char format[100] = "%hd  %ld  %ld  %hd  %hd  %ld";
...
Suite* test_s21_sscanf_d() {
  Suite* s = suite_create("\033[32m S21_SSCANF_D \033[0m");
  TCase* tc = tcase_create("\033[31m test s21_sscanf_d \033[0m");
