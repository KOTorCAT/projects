...
START_TEST(test_7) {
  ...
  char str[100] = "-1 011 11 0x2002321 0xaaab1";
...
START_TEST(test_9) {
  char format[100] = "%*i%*i%10i%2i%21i%11i";
  char str[100] = "-1 011 11 0x2002321 0xaaab1 111";
...
START_TEST(test_10) {
  char format[100] = "%hi  %li  %li  %hi  %hi  %li";
  char str[100] = "0x2121 008381 123123123123 0x3123 021312  -2100000";
...
Suite* test_s21_sscanf_i() {
  Suite* s = suite_create("\033[32m S21_SSCANF_I \033[0m");
  TCase* tc = tcase_create("\033[31m test s21_sscanf_i \033[0m");
