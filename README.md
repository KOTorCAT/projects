...
- Код-ревью  
- Проектирование архитектуры (учебные проекты)  
...
- Индивидуальный проект: реализация базовых функций UNIX-утилит.  

### **Библиотеки: аналоги `string.h` и `decimal`** *(C, командный проект)*  
- Разработка функций для работы со строками и числами с фиксированной точкой.  

### **Система учета для МЧС** *(JS, HTML, SQL)*  
- Веб-портал для управления данными о персонале и технике.  
- **Функционал:** CRUD-операции с базой данных.  
